...
import { Product_card } from './Product_components/Product_card';
import './App.css';
import { Product_details } from './Product_components/Product_details';
...
const data =
    [
        ...
        },
        {
            ...
            "price": 168, "description": "Satisfaction Guaranteed. Return or exchange any order within 30 days.Designed and sold by Hafeez Center in the United States. Satisfaction Guaranteed. Return or exchange any order within 30 days.", "category": "jewelery", "image": "https://fakestoreapi.com/img/61sbMiUnoGL._AC_UL640_QL65_ML3_.jpg", "rating": { "rate": 3.9, "count": 70 }
        },
        {
            "id": 7,
        ...
        },
        {
            ...
            "category": "electronics", "image": "https://fakestoreapi.com/img/71kWymZ+c+L._AC_SX679_.jpg", "rating": { "rate": 4.8, "count": 319 }
        ...
        },
        {
            ...
            "category": "women's clothing", "image": "https://fakestoreapi.com/img/81XH0e8fefL._AC_UY879_.jpg",
...
const App = () => {
    return (
        <Router>
            <Routes>
                <Route path="/" element={<Product_card data={data} />} />
                <Route path="/details/:itemId" element={<Product_details data={data} />} />
            </Routes>
        </Router>
    );
};
